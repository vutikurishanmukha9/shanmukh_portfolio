  ...
  return (
    <>
      ...
      <div className="fixed inset-0 -z-20 overflow-hidden bg-background">
        <div
          className="absolute inset-x-0 top-0 h-72 opacity-[0.08]"
          style={{ background: 'linear-gradient(180deg, hsl(var(--primary)) 0%, transparent 100%)' }}
        />
        <div
          className="absolute inset-x-0 bottom-0 h-72 opacity-[0.08]"
      ...
      <div 
        className="fixed inset-0 -z-10 overflow-hidden opacity-[0.22] pointer-events-none"
        style={{
          backgroundImage: `
      ...
      <div 
        className="fixed inset-0 pointer-events-none z-[9999] opacity-[0.018] mix-blend-overlay"
        style={{
